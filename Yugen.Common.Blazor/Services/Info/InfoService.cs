...
public class InfoService : IInfoService
{
    ...
    public async Task<Dictionary<string, string>> GetAsync(bool isAuthenticated)
    {
        ...
        _list = new Dictionary<string, string>
        {
            ...
            { "DefaultThreadCurrentCulture", CultureInfo.DefaultThreadCurrentCulture?.DisplayName },
            { "DefaultThreadCurrentUICulture", CultureInfo.DefaultThreadCurrentUICulture?.DisplayName },
            { "InstalledUICulture", CultureInfo.InstalledUICulture?.DisplayName },
            { "InvariantCulture", CultureInfo.InvariantCulture?.DisplayName }
        };
